    ...
    <div class="mt-6 grid grid-cols-1 gap-8 lg:grid-cols-2">
        <div class="rounded-xl border border-gray-200 bg-white p-6 dark:border-gray-700 dark:bg-gray-800">
            ...
            <dl class="mt-4 space-y-2 text-sm">
                ...
                <div class="flex justify-between"><dt class="text-gray-500 dark:text-gray-400">Level</dt><dd class="text-gray-900 dark:text-white">{{ $student->studentProfile?->level?->name ?? '—' }}</dd></div>
                    ...
                    <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                        @foreach ($student->payments as $payment)
                            <tr>
                                ...
                                <td class="py-2 pr-4 text-gray-700 dark:text-gray-300">{{ $payment->course->title }}</td>
